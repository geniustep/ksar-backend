...
class Settings(BaseSettings):
    ...
    APP_NAME: str = "KSAR"
    DEBUG: bool = False
    ALLOWED_ORIGINS: str = "https://ksar.geniura.com,https://www.kksar.ma,https://kksar.ma,http://localhost:3001,http://127.0.0.1:3001,http://localhost:4500,http://127.0.0.1:4500"
